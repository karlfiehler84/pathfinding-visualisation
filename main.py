...
def drawGrid(win,cellWidth):
    for i in range(0,width,cellWidth):
        pygame.draw.line(win, (10,10,10), (i, 0), (i,width))
        pygame.draw.line(win, (10,10,10), (0,i), (width, i))
